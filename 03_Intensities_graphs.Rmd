---
title: "Create graphs from the Cell Profiler output"
...
```{r read_the_files, echo = T, message=FALSE, include=FALSE}
# Read all csv files into tibbles
...
# png(file="antibody_intensities.png", width=1000, height=750)
